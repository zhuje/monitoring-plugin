...
# ==============================================================================
# Monitoring-plugin Development Workspace Setup
# ==============================================================================
...
# --- Configuration ---
readonly PERSSES_PATH="/Users/jezhu/Git/perses_core" # REPLACE with the absolute path to local perses/perses repo 
readonly MONITORING_PATH="/Users/jezhu/Git/monitoring-plugin" # REPLACE with the absolute path to your openshift/monitoring-plugin repo
...
# 2. Check for project directories.
# The Perses path is only checked if the user opted to enable it.
if [[ "$REPLY" =~ ^[Yy]$ ]]; then
...
# 3. Check if the oc login is valid and the cluster is reachable.
