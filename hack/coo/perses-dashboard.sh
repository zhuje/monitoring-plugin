            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum(namespace_cpu:kube_pod_container_resource_requests:sum{cluster="$cluster"})
                    / sum(kube_node_status_allocatable{job="kube-state-metrics",resource="cpu",cluster="$cluster"})'
    '0_2':
      kind: Panel
      spec:
        display:
            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum(namespace_cpu:kube_pod_container_resource_limits:sum{cluster="$cluster"})
                    / sum(kube_node_status_allocatable{job="kube-state-metrics",resource="cpu",cluster="$cluster"})'
    '0_3':
      kind: Panel
      spec:
            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: '1 - sum(:node_memory_MemAvailable_bytes:sum{cluster="$cluster"})
                    / sum(node_memory_MemTotal_bytes{job="node-exporter",cluster="$cluster"})'
    '0_4':
      kind: Panel
      spec:
        display:
            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum(namespace_memory:kube_pod_container_resource_requests:sum{cluster="$cluster"})
                    / sum(kube_node_status_allocatable{job="kube-state-metrics",resource="memory",cluster="$cluster"})'
    '0_5':
      kind: Panel
      spec:
        display:
            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum(namespace_memory:kube_pod_container_resource_limits:sum{cluster="$cluster"})
                    / sum(kube_node_status_allocatable{job="kube-state-metrics",resource="memory",cluster="$cluster"})'
    '10_0':
      kind: Panel
      spec:
            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'ceil(sum by(namespace) (rate(container_fs_reads_total{job="kubelet",
                    metrics_path="/metrics/cadvisor", id!="",
                    ...
                    id!="", cluster="$cluster", namespace!=""}[$__rate_interval])))'
            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum by(namespace) (rate(container_fs_reads_bytes_total{job="kubelet",
                    metrics_path="/metrics/cadvisor", id!="",
                    device=~"(/dev.+)|mmcblk.p.+|nvme.+|rbd.+|sd.+|vd.+|xvd.+|dm-.+|dasd.+",
                    cluster="$cluster", namespace!=""}[$__rate_interval]) +
            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum by(namespace) (rate(container_fs_reads_total{job="kubelet",
            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum by(namespace) (rate(container_fs_writes_total{job="kubelet",
                    metrics_path="/metrics/cadvisor",
                    device=~"(/dev.+)|mmcblk.p.+|nvme.+|rbd.+|sd.+|vd.+|xvd.+|dm-.+|dasd.+",
                    id!="", cluster="$cluster", namespace!=""}[$__rate_interval]))'
                  seriesNameFormat: ''
            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum by(namespace) (rate(container_fs_writes_bytes_total{job="kubelet",
                    metrics_path="/metrics/cadvisor",
                    device=~"(/dev.+)|mmcblk.p.+|nvme.+|rbd.+|sd.+|vd.+|xvd.+|dm-.+|dasd.+",
                    id!="", cluster="$cluster", namespace!=""}[$__rate_interval]))'
                  seriesNameFormat: ''
              ...
              plugin:
                ...
                spec:
                  ...
                  query: 'sum by(namespace) (rate(container_fs_reads_bytes_total{job="kubelet",
                    ...
                    device=~"(/dev.+)|mmcblk.p.+|nvme.+|rbd.+|sd.+|vd.+|xvd.+|dm-.+|dasd.+",
                    id!="", cluster="$cluster", namespace!=""}[$__rate_interval]) +
                    rate(container_fs_writes_bytes_total{job="kubelet",
                    metrics_path="/metrics/cadvisor",
                    device=~"(/dev.+)|mmcblk.p.+|nvme.+|rbd.+|sd.+|vd.+|xvd.+|dm-.+|dasd.+",
                    id!="", cluster="$cluster", namespace!=""}[$__rate_interval]))'
                  seriesNameFormat: ''
            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum(node_namespace_pod_container:container_cpu_usage_seconds_total:sum_irate{cluster="$cluster"})
                    by (namespace)'
                  seriesNameFormat: '{{namespace}}'
    '2_0':
      kind: Panel
            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum(kube_pod_owner{job="kube-state-metrics", cluster="$cluster"})
                    by (namespace)'
                  seriesNameFormat: ''
          - kind: TimeSeriesQuery
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'count(avg(namespace_workload_pod:kube_pod_owner:relabel{cluster="$cluster"})
                    by (workload, namespace)) by (namespace)'
                  seriesNameFormat: ''
          - kind: TimeSeriesQuery
            spec:
              plugin:
            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum(container_memory_rss{job="kubelet", metrics_path="/metrics/cadvisor",
                    cluster="$cluster", container!=""}) by (namespace)'
                  seriesNameFormat: '{{namespace}}'
    '4_0':
      kind: Panel
      spec:
            ...
            spec:
              plugin:
                ...
                spec:
                  ...
                  query: 'sum(container_memory_rss{job="kubelet", metrics_path="/metrics/cadvisor",
                    cluster="$cluster", container!=""}) by (namespace) /
                    sum(namespace_memory:kube_pod_container_resource_requests:sum{cluster="$cluster"})
                    by (namespace)'
                  seriesNameFormat: ''
          - kind: TimeSeriesQuery
            spec:
            ...
            spec:
              plugin:
                ...
                spec:
                  ...
                  query: 'sum(container_memory_rss{job="kubelet", metrics_path="/metrics/cadvisor",
                    cluster="$cluster", container!=""}) by (namespace) /
                    sum(namespace_memory:kube_pod_container_resource_limits:sum{cluster="$cluster"})
                    by (namespace)'
                  seriesNameFormat: ''
    '5_0':
      kind: Panel
            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum(irate(container_network_receive_bytes_total{job="kubelet",
            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum(irate(container_network_transmit_bytes_total{job="kubelet",
                    metrics_path="/metrics/cadvisor", cluster="$cluster", namespace=~".+"}[$__rate_interval]))
                    by (namespace)'
                  seriesNameFormat: ''
          - kind: TimeSeriesQuery
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum(irate(container_network_receive_packets_total{job="kubelet",
                    metrics_path="/metrics/cadvisor", cluster="$cluster", namespace=~".+"}[$__rate_interval]))
                    by (namespace)'
                  seriesNameFormat: ''
          - kind: TimeSeriesQuery
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum(irate(container_network_transmit_packets_total{job="kubelet",
                    metrics_path="/metrics/cadvisor", cluster="$cluster", namespace=~".+"}[$__rate_interval]))
                    by (namespace)'
                  seriesNameFormat: ''
          - kind: TimeSeriesQuery
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum(irate(container_network_receive_packets_dropped_total{job="kubelet",
                    metrics_path="/metrics/cadvisor", cluster="$cluster", namespace=~".+"}[$__rate_interval]))
                    by (namespace)'
                  seriesNameFormat: ''
          - kind: TimeSeriesQuery
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'sum(irate(container_network_transmit_packets_dropped_total{job="kubelet",
                    metrics_path="/metrics/cadvisor", cluster="$cluster", namespace=~".+"}[$__rate_interval]))
                    by (namespace)'
                  seriesNameFormat: ''
    '6_0':
            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'avg(irate(container_network_receive_bytes_total{job="kubelet",
                    metrics_path="/metrics/cadvisor", cluster="$cluster", namespace=~".+"}[$__rate_interval]))
                    by (namespace)'
                  seriesNameFormat: '{{namespace}}'
    '7_1':
            ...
            spec:
              plugin:
                ...
                spec:
                  datasource:
                    kind: PrometheusDatasource
                  query: 'avg(irate(container_network_transmit_bytes_total{job="kubelet",
                    metrics_path="/metrics/cadvisor", cluster="$cluster", namespace=~".+"}[$__rate_interval]))
                    by (namespace)'
                  seriesNameFormat: '{{namespace}}'
    '8_0':
