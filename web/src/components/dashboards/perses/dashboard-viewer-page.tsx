...
const DashboardViewerPageWrapper: FC = () => {
  return (
    <QueryParamProvider adapter={ReactRouter5Adapter}>
      <QueryClientProvider client={queryClient}>
        <DashboardViewerPage_ />
      </QueryClientProvider>
    </QueryParamProvider>
  );
};

// Export wrapper for console extensions
export const MpCmoDashboardViewerPage: React.FC = () => {
  return <DashboardViewerPageWrapper />;
};

export default DashboardViewerPageWrapper;
