 ...
 * at build time via webpack DefinePlugin and also set at runtime via BannerPlugin.
 *
 * This dual approach ensures:
 * 1. Build-time availability for imports/static references
 * 2. Runtime availability for Module Federation dynamic loading
 */
